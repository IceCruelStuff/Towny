...
class CommandManager
{
    ...
    public static function registerAll(TownyLoader $plugin) : void
    {
        ...
        $server->getCommandMap()->register("towny", new TownyCommand(TownyLoader::getInstance()->getLanguage()->translateString("towny.command.name"),
                                                                     TownyLoader::getInstance()->getLanguage()->translateString("towny.command.description")));
